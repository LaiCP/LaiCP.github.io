var _fnUtil = {
  ...
  pullToRefresh: function(opt) {
    ...
    var loaderImg = opt.loaderImg || '/webapp/images/ajax-loader.gif';
    var arrowImg = opt.arrowImg || '/webapp/images/arrow.png';
    ...
    myScroll.on('scrollEnd', function() {
      if (this.y >= -ptrHeight && this.y < 0) {
        ...
        //ajax上拉刷新数据
        $.ajax({
          url: '/webapp/mock/refresh-livelist.json',
      ...
      if (maxY > -ptrHeight && maxY < 0) {
        ...
        var self = this;
        $.ajax({
          url: '/webapp/mock/more-livelist.json',
          success: function(res) {
            if (res.ret) {
